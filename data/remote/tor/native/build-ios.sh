#!/usr/bin/env bash
#
# Build Arti static library for iOS
#
# Requirements:
...
#
# Usage:
#   ./build-ios.sh              # Build all architectures
#   ./build-ios.sh --clean      # Clean and rebuild
...
check_prerequisites() {
  ...
  local TARGETS=("aarch64-apple-ios" "x86_64-apple-ios" "aarch64-apple-ios-sim")
  ...
  print_success "All iOS Rust targets installed"
...
build_target() {
  ...
  local LIB_DST="$OUTPUT_DIR/libarti_ios.a"
...
build_target "x86_64-apple-ios" "ios-x64"
build_target "aarch64-apple-ios-sim" "ios-sim-arm64"
