...
#[no_mangle]
pub extern "C" fn Java_com_bitchat_tor_TorManager_nativeGetVersion(
    env: JNIEnv,
    _class: JClass,
) -> jstring {
...
#[no_mangle]
pub extern "C" fn Java_com_bitchat_tor_TorManager_nativeSetLogCallback(
    env: JNIEnv,
    _class: JClass,
    callback: JObject,
) {
...
#[no_mangle]
pub extern "C" fn Java_com_bitchat_tor_TorManager_nativeInitialize(
    mut env: JNIEnv,
    _class: JClass,
    data_dir: JString,
) -> jint {
...
#[no_mangle]
pub extern "C" fn Java_com_bitchat_tor_TorManager_nativeStartSocksProxy(
    _env: JNIEnv,
    _class: JClass,
    port: jint,
) -> jint {
...
#[no_mangle]
pub extern "C" fn Java_com_bitchat_tor_TorManager_nativeStop(
    _env: JNIEnv,
    _class: JClass,
) -> jint {
